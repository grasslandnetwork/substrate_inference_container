...
def detect(save_img=False):
    ...
    if webcam:
        ...
        # view_img = True # commented out by David Thompson <2021-10-01 Fri 17:33> to allow the option of including the command line argument "--view-img" (see below) if the user wants "view_img = True"
...
if __name__ == '__main__':
    ...
    parser.add_argument('--weights', nargs='+', type=str, default=['p6.pt'], help='model.pt path(s)')
